            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item {{ $ActiveTab === 'accounts' ? 'active' : '' }}">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item {{ $SubActiveTab === 'updateProfile' ? 'active' : '' }}">
                            <a href="" class="menu-link">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <!-- Profile Update Form -->
                                    <form action="{{ route('users.accounts.updateProfile', ['id' => $user->id]) }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <!-- Overriding the method to PUT -->
