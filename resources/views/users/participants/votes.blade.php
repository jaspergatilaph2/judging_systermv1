    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item {{$ActiveTab === 'votes' ? 'active' : ''}}">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item {{$SubActiveTab === 'view votes' ? 'active' : ''}}">
                            <a href="" class="menu-link">
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Create/</span> Or Votes</h4>
                        ...
                        <div class="col-xl">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form method="POST" action="{{ route('users.participants.vote.store') }}">
                                        @csrf
                                        ...
                                        {{-- Voter Name --}}
                                        <div class="mb-3">
                                            <label class="form-label" for="voter-name">Your Name</label>
                                            <input
                                                type="text"
                                                class="form-control"
                                                id="voter-name"
