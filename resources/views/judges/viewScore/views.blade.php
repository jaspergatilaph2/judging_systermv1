            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item {{ $ActiveTab  === 'view' ? 'active' : ''}}">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item {{ $SubActiveTab === 'scores' ? 'active' : '' }}">
                            <a href="" class="menu-link">
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <!-- Create a table -->
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Scores/</span>Show Score List By the Judges</h4>
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive text-nowrap">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach($judge->participantScores as $participantId => $total)
                                        @php
                                        $participant = \App\Models\Participants::find($participantId);
                                        @endphp
                                        <tr>
                                            <td>{{ $participant->student_name ?? 'Unknown' }}</td>
