          ...
          <ul class="menu-sub">
            ...
            <li class="menu-item">
              <a href="" class="menu-link">
                ...
                <li class="menu-item {{$AccountsTab === 'accounts' ? 'active' : ''}}">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <img src="{{ auth()->guard('judges')->user()->image 
        ? asset('storage/' . auth()->guard('judges')->user()->image)
        : asset('assets/img/avatars/default.png') }}"
                                            alt="avatar"
                                            class="d-block rounded mt-2" width="100" height="100" />
                                    </div>
                                </div>
                                <!-- /Account -->
                            </div>
