    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item {{$ActiveTab === 'Judges' ? 'active' : ''}}">
                    <a href="javascript:void(0);" class="menu-link menu-toggle">
                    ...
                    <ul class="menu-sub">
                        ...
                        <li class="menu-item {{$SubActiveTab === 'View Judges' ? 'active' : ''}}">
                            <a href="" class="menu-link">
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <!-- Create a table -->
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Judges/</span>Show List Judges</h4>
                    <div class="card">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#editModal{{ $judge->id }}">
                                                    <i class="fa fa-user-edit"></i>
                                                </button>

                                                <!-- Edit Modal for each judge -->
                                                <div class="modal fade" id="editModal{{ $judge->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $judge->id }}" aria-hidden="true">
                                                        ...
                                                        <div class="modal-content">
                                                            <form method="POST" action="{{ route('admin.judges.update', $judge->id) }}" enctype="multipart/form-data">
                                                                ...
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="editModalLabel{{ $judge->id }}">Edit Judge</h5>
                                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Full Name</label>
                                                                        <input type="text" class="form-control" name="name" value="{{ $judge->name }}" required>
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Organization / Affiliation</label>
                                                                        <input type="text" class="form-control" name="organization" value="{{ $judge->organization }}">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Email</label>
                                                                        <input type="email" class="form-control" name="email" value="{{ $judge->email }}" required>
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Phone No</label>
                                                                        <input type="text" class="form-control" name="phone" value="{{ $judge->phone }}">
                                                                    </div>
                                                                    <div class="mb-3">
                                        ...
                                        <div class="modal fade" id="viewModal{{ $judge->id }}" tabindex="-1"
                                            aria-labelledby="viewModalLabel{{ $judge->id }}" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="viewModalLabel{{ $judge->id }}">Judge Details</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
