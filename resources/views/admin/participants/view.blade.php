    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1">
                ...
                <li class="menu-item {{ $ActiveTab  === 'admin' ? 'active' : ''}}">
                    ...
                    <ul class="menu-sub">
                        <li class="menu-item {{ $SubActiveTab === 'participants' ? 'active' : '' }}">
        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Participants /</span>History</h4>

                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="mb-0">View Particpants</h5>
                        </div>
