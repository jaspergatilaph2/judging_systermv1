                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ route('admin.criteria.store') }}">
                                        ...
                                        <button type="button" class="btn btn-secondary mb-3" onclick="addCriteriaField()">+ Add Another Criteria</button>
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="criteria-type">Contest Type (optional)</label>
